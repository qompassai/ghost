<!-- /qompassai/ghost/README.md -->
<!-- ---------------------------- -->
<!-- Copyright (C) 2025 Qompass AI, All rights reserved -->

<h2> Qompass AI Gateway Hosting Onion Secure Transmission ("Ghost") Protocol </h2>

<h3> Qompass AI Ghost: Semper Audere </h3>
...
<a href="https://www.php.net/docs.php">
  <img src="https://img.shields.io/badge/PHP_Documentation-blue?style=flat-square" alt="PHP Documentation">
</a>
<a href="https://github.com/topics/php-tutorial">
  <img src="https://img.shields.io/badge/PHP_Tutorials-green?style=flat-square" alt="PHP Tutorials">
</a>
<br>
...
```sh
curl -fSsL https://raw.githubusercontent.com/qompassai/ghost/main/scripts/quickstart.sh | sh
```
  </div>
...
#!/bin/sh
# /qompassai/ghost/scripts/quickstart.sh
# Qompass AI Ghost Quick Start
# Copyright (C) 2025 Qompass AI, All rights reserved
####################################################
        : TO DO - in the meantime please refer to quickstart.rst in the docs directory
</pre> </details> <p>Or, <a href="https://github.com/qompassai/ghost/blob/main/scripts/quickstart.sh" target="_blank">View the quickstart script</a>.</p>
