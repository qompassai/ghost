<?php
// /qompassai/ghost/common_config.php
//-----------------------------------
...
const DBUSER = 'postfix'; 
const DBPASS = 'YOUR_PASSWORD';
const DBNAME = 'postfix';
const DBVERSION = 1;
const PERSISTENT = true;
const CAPTCHA_DIFFICULTY = 1;
const RESERVED_USERNAMES = ['about', 'abuse', 'admin', 'administrator', 'billing', 'contact', 'daemon', 'ftp', 'help', 'hostmaster', 'info', 'legal', 'list', 'list-request', 'lists', 'maildaemon', 'mailerdaemon', 'mailer-daemon', 'marketing', 'media', 'news', 'newsletter', 'nobody', 'noc', 'noreply', 'no-reply', 'notification', 'notifications', 'notify', 'offer', 'offers', 'office', 'official', 'order', 'orders', 'phish', 'phishing', 'postmaster', 'root', 'sale', 'sales', 'security', 'service', 'services', 'shop', 'shopping', 'spam', 'staff', 'support', 'survey', 'system', 'team', 'teams', 'unsbubscribe', 'uucp', 'usenet', 'user', 'username', 'users', 'web', 'webmail', 'webmaster', 'webmasters', 'welcome', 'www'];
const CANONICAL_URL = 'https://qompass.ai/mail/';
const PRIVACY_POLICY_URL = '/privacy.php';
const WEB_XMPP_URL = 'https://qompass.ai:5281/conversejs';
const XMPP_BOSH_URL = 'https://qompass.ai:5281/http-bind';
const XMPP_FILE_PROXY = 'proxy.qompass.ai';
const ROOT_URL = '/mail/';
const CONTACT_URL = '/contact.php';
const CLEARNET_SERVER = 'qompass.ai';
const ONION_SERVER = 'mapas3rtn54uwmofdo3x2bsdifr47huasnmbgqzfrec5ubupvtpid.onion';
const DBHOST_PROSODY = 'localhost';
const DBUSER_PROSODY = 'prosody';
const DBPASS_PROSODY = 'YOUR_PASSWORD';
const DBNAME_PROSODY = 'prosody';
